"""
Django settings for bitter_river_1 project.
...
ROOT_URLCONF = 'bitter_river_1.urls'
...
WSGI_APPLICATION = 'bitter_river_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Bitter River Support <support@bitter-river-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_river_1 API",
    "DESCRIPTION": "API documentation for bitter_river_1 App",
    "VERSION": "v1",
}
